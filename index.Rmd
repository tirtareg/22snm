...
#data <- filter(db, beasiswa == "KIP")
valueBox(
  value = paste(format(439, big.mark = " "), " (", 
                round(439/nrow(db)*100, 0), "%)",
                sep = ""),
...
names(data) <- c("Nama Sekolah", "Alamat Kota/Kab", "Alamat Provinsi", "Lulus SNMPTN", "Sudah Registrasi", "Belum Registrasi")
...
### Berikut adalah daftar nama mahasiswa baru Universitas Sultan Ageng Tirtayasa jalur SNMPTN. (**gunakan Search untuk pencarian cepat**)
...
names(data) <- c("Nama Sekolah", "Alamat Kota/Kab", "Alamat Provinsi", "Lulus SNMPTN", "Registrasi", "Tidak Registrasi", "Punya NIM")
